...
from xrpl_helper import connect, fund_wallet, get_balance, set_sign_key, pay, get_payment_transactions, get_regularkey_transactions, get_addr
...
if __name__ == '__main__':
    ...
    #connect("http://docker.its.uni-luebeck.de:20001/")
